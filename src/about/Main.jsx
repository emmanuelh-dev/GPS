    ...
    <>
      <Grid container spacing={2} className={classes.mainGrid}>
        <Grid item md={4} className={classes.mainGridText}>
          ...
          <Typography variant="p">
            Ten el control de tus GPS en todo momento. Monitoreo en tiempo real.
          </Typography>
          <Link to="/login">
      ...
      <section className={classes.section}>
        ...
        <Typography variant="body1">
          ¡Hola que tal! Somos tu asistente virtual diseñado exclusivamente para
          simplificar la vida de los transportistas. Desde el inicio del viaje
          hasta la facturación, Gonzher está aquí para acompañarte en cada paso
          del camino. Con soporte para la Carta Porte 3.0, una plataforma de GPS
          para monitoreo 24/7 y muchas más funciones específicas para el
          transporte, hemos creado Gonzher pensando en tus necesidades únicas.
        </Typography>
      </section>
      ...
      <section className={classes.section}>
        ...
        <Typography variant="body1">
          Esta documentación está diseñada para guiarte a través de todas las
          funciones de Gonzher. Encuentra tutoriales paso a paso, detalles sobre
          características específicas y consejos para optimizar tu experiencia.
          Ya seas un transportista experimentado o recién comenzando, estamos
      ...
      <footer>
        <Typography variant="body1">
          Gracias por confiar en Gonzher para simplificar tu experiencia de
          facturación y transporte. Si tienes preguntas o necesitas asistencia,
